...
<form id="formPost" method="post" enctype="multipart/form-data" action="util/pc/processo-manual.php">
    <div class="card card-block">
        <div class="form-group row"><label class="col-sm-2 form-control-label text-xs-right">
                Link do Steam:
            </label>
            <div class="col-sm-10"><input name="linkSteam" id="linkSteam" type="text" class="form-control boxed"></div>
        </div>
        <div class="form-group row"><label class="col-sm-2 form-control-label text-xs-right">
                Nome do Jogo:
            </label>
            <div class="col-sm-10"><input name="nomeJogo" id="nomeJogo" type="text" class="form-control boxed" placeholder=""
                                          required></div>
        </div>
        ...
        <div class="col-sm-10 form-group row">
            <div class="form-group">
                <label style="margin-left: 30px"
                       class="col-sm-2 form-control-label text-xs-right">Introdução:
                </label>
        ...
        <div class="col-sm-10 form-group row">
            <div class="form-group">
                <label style="margin-left: 30px"
                       class="col-sm-2 form-control-label text-xs-right">Descrição:
                </label>
                <textarea style="margin-left: 208px" class="form-control"
        ...
        <div class="col-sm-10 form-group row">
            <div class="form-group">
                <label style="margin-left: 30px"
                       class="col-sm-2 form-control-label text-xs-right">Requisitos:
                </label>
                <textarea style="margin-left: 208px" class="form-control"
                          name="requisitos" id="requisitos"></textarea>
            </div>
        </div>
        <div class="form-group row">
