...
<div class="card card-block">
    ...
    <div class="form-group row">
        ...
        <div style="display: none" id="div_focusKeyword" class="col-sm-10"><input name="focusKeyword" id="focusKeyword" value="<?=$desc?>" type="text" class="form-control boxed" onclick="this.focus();this.select()">
        </div>
        <div style="margin-left: 230px" class="form-group">
    ...
    <div class="form-group row">
        ...
        <div style="display: none" id="div_seo" class="col-sm-10"><input name="seo" id="seo" value="<?=$metaDesc?>" type="text" class="form-control boxed" onclick="this.focus();this.select()">
        </div>
        <div style="margin-left: 230px" class="form-group">
    ...
    <div class="form-group row">
        ...
        <h7 style="margin-left: 20px"><?=$categoria?></h7>
    </div>
    <div class="form-group">
